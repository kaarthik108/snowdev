...
from snowdev.snow_functions.utils.templates.streamlit import TEMPLATE as STREAMLIT_TEMPLATE
...
class SnowBot:
    ...
    def get_qa_prompt_for_type(template_type):
        ...
        return PromptTemplate(template=SnowBot.TEMPLATES[template_type], input_variables=["question", "context"])
    ...
    def get_chain_gpt(db):
        ...
        chain = RetrievalQA.from_chain_type(llm, chain_type="stuff", retriever=db.as_retriever(), chain_type_kwargs = {"prompt": SnowBot.QA_PROMPT})
        return chain
    ...
    def create_new_ai_component(udf_name, prompt, template_type):
        ...
        print(colored(f"✅ {template_type.upper()} {udf_name} generated successfully using AI!", "green"))